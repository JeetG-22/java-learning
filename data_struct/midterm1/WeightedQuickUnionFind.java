...
public class WeightedQuickUnionFind {
    ...
    static private int[] parent;   // used by weighted union-find, see quick-union slides
	static private int[] size;     // used by weighted union-find. 
	...
	*/
	...
	public static void main(String[] args) {
		WeightedQuickUnionFind wqf = new WeightedQuickUnionFind(10);
		wqf.union(1, 2);
		wqf.union(4, 5);
		wqf.union(6, 7);
		wqf.union(0, 1);
